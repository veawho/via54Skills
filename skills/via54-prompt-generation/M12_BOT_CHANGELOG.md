...
## ✅ 改对了 (没回滚, 真治本)| **3a18b59 (本次)** | B38 + B39 真事件返"渲染超时"真因真找到: m12 bot 58336 跑老代码 (idle 5s) 时处理, B38 + B39 outbound 返占位符。**我之前没真重启 m12 bot** 让新代码生效, 3 段构图新模板 + idle 30s (212c805 + 8205b7c) 在 m12 bot 72119 (3:18 前启动) 才生效。**m12 bot 72119 真跑新代码, B40 mock 测 3 段构图 60+ 秒真返 3 段 (含 fallback)** ✅ |
